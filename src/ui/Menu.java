...
public class Menu {
	...
	public void infoGame(boolean gameOver) {
		...
		if (info!=null) {
			...
			//n-> columnas, m->filas,s->snakes,e->ladders,p->players
		...
		if (connections!=null) {
			...
			if (enlaces < verficationEnlaces) {
				...
				System.out.println("Ingrese el username de la persona que jugará como Rick");
				String rick = entry.nextLine();

				System.out.println("Ingrese el username de la persona que jugará como Morty");
